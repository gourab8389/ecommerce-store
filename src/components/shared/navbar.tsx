import { CartSheet } from "../landing/cart-sheet";
...
const Navbar = () => {
  return (
    <div className="w-full h-[5rem] fixed top-0 left-0 right-0 mx-auto shadow-md flex items-center justify-center">
      <section className="w-full max-w-screen-2xl px-5 md:px-14 flex md:gap-16 justify-between items-center md:justify-center h-full">
